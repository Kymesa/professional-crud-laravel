                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <h2 class="text-4xl font-black text-black mb-4 dark:text-white">
                            Professional Laravel <span class="text-blue-600 dark:text-blue-500">Crud</span>
                        </h2>
                        <h3 class="text-xl leading-relaxed font-medium text-gray-700 dark:text-gray-300">
                            Inspiring results from day one without the pain. Get your own custom dashboard and start
                            building amazing services.
                        </h3>
                    </div>
                    <!-- END Heading -->
                    ...
                    <div>
                        <a href="{{ route('login') }}"
                            ...
                            <svg class="hi-mini hi-plus-circle inline-block w-5 h-5 opacity-50"
            ...
            <div class="flex items-center lg:justify-end text-blue-500">
                <svg viewBox="0 0 753 480.951" xmlns="http://www.w3.org/2000/svg" class="w-full">
                    ...
                    <path
                        ...
                        fill="#374151"></path>
                    <path fill="#9e616a" d="M606.671 467.453h-13.14l-6.251-50.685 19.394.001-.003 50.684z"></path>
                    <path d="M610.023 480.19h-42.37v-.537a16.493 16.493 0 0116.491-16.491h.001l25.878.001z" fill="#374151">
                    </path>
                    <path fill="#9e616a" d="M525.57 467.453h-13.141l-6.251-50.685 19.394.001-.002 50.684z"></path>
                    <path d="M528.921 480.19h-42.37v-.537a16.493 16.493 0 0116.491-16.491h.002l25.878.001z" fill="#374151">
                    </path>
                    <path
                    ...
                    <ellipse cx="512.571" cy="48.405" rx="24.509" ry="14.705" fill="#374151"></ellipse>
                    ...
                    <path
                        ...
                        fill="#374151"></path>
                    <path d="M416.745 333.873l282.56-56.404-23.613-118.297-282.561 56.404z" fill="#fff"></path>
                    <path
                    ...
                    <path d="M752 480.951H1a1 1 0 010-2h751a1 1 0 010 2z" fill="#374151"></path>
                </svg>
            </div>
        </div>
    </div>
