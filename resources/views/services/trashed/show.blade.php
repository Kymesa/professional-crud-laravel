...
@section('content')
    ...
    <div class="mb-24 mx-12 md:mx-36 xl:mx-96">
        ...
        <a href="{{ route('services.destroy', $post->id) }}">
            <button type="button"
                class="text-white mt-1 bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:red:bg-blue-700 dark:focus:ring-blue-800">DESTROY</button>
        </a>
    </div>
