...
@section('content')
    ...
    <div id="page-container"
        class="flex flex-col w-full min-h-screen min-w-[320px] bg-gray-100 dark:text-gray-100 dark:bg-gray-900">
        <!-- Page Content -->
        <main id="page-content" class="flex flex-auto flex-col max-w-full">
            <div class="min-h-screen flex items-center justify-center relative overflow-hidden max-w-10xl w-full">
                <!-- Sign In Section -->
                <section class="py-0 w-full max-w-xl">
                    <!-- Header -->
                    <header class="mb-8 text-center">
                        <h1 class="text-2xl font-bold inline-flex items-center mb-2 space-x-2">
                            <svg class="hi-mini hi-cube-transparent inline-block w-5 h-5 text-blue-600 dark:text-blue-500"
                            ...
                            <form action="{{ route('login.submit') }}" class="space-y-6" method="POST">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center my-5">
                                        ...
                                        <span
                                            class="text-xs font-medium text-gray-800 bg-gray-100 rounded-full px-3 py-1 dark:bg-gray-700 dark:text-gray-200">or
                                            sign in with</span>
                                        <span aria-hidden="true"
                                            class="grow bg-gray-100 rounded h-0.5 dark:bg-gray-700/75"></span>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        <button type="button"
                                            ...
                                            <svg class="bi bi-facebook inline-block w-4 h-4 text-[#1877f2]"
                                        ...
                                        <button type="button"
                                            class="inline-flex justify-center items-center space-x-2 border font-semibold rounded-lg px-3 py-2 leading-5 text-sm border-gray-200 bg-white text-gray-800 hover:border-gray-300 hover:text-gray-900 hover:shadow-sm focus:ring focus:ring-gray-300 focus:ring-opacity-25 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:text-gray-200 dark:focus:ring-gray-600 dark:focus:ring-opacity-40 dark:active:border-gray-700">
                                            <svg class="bi bi-twitter inline-block w-4 h-4 text-[#1da1f2]"
                                                xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16"
                                                aria-hidden="true">
                                                <path
                    ...
                    <!-- Footer -->
                    <div class="text-sm text-gray-500 text-center mt-6 dark:text-gray-400">
                    </div>
                    <!-- END Footer -->
                </section>
                <!-- END Sign In Section -->
